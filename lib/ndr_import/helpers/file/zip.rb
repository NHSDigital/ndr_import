    ...
    module File
      ...
      module Zip
        ...
        def unzip_file(source, destination, pattern = //)
          # SECURE TVB Mon Aug 13 14:41:05 BST 2012 : SafePath will raise exception if insecure path is constructed
          ...
          raise 'Not allowed in external environment' if Rails.env.external?
